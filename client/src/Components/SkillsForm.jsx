  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <input
          type="text"
          placeholder="Enter a skill (e.g., JavaScript, Web Development)"
      ...
      <div className="bg-blue-50 p-3 rounded-lg">
        <p className="text-sm text-blue-800">
          💡 Tip: Include a mix of technical skills (e.g., programming languages, tools)
          and soft skills (e.g., communication, teamwork) relevant to the job you're
          applying for.
        </p>
      </div>
    </div>
