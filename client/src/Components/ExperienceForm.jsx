...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generateDescription = async(index)=>{
    ...
    try {
      const {data: response} = await api.post('/api/ai/enhance-job-desc' , {userContent: prompt}, {headers: { Authorization : `Bearer ${token}`}})
    ...
    <div className="space-y-6">
      ...
      {data.length === 0 ? (
        <div className="text-center py-8 text-gray-500">
          ...
          <p className="text-sm">
            Add your work experience using the button to get started
          </p>
        </div>
      ) : (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full text-sm border px-3 py-2 rounded-lg resize-none"
